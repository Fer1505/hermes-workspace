...
async function switchModel(
  ...
  // Write the model change through Workspace's config route. It merges through
  // the dashboard-backed PUT path when Hermes Agent dashboard APIs are active.
                        ...
                        <div className="flex flex-wrap items-start gap-2">
                          ...
                          >
                            <button
                              ...
                              disabled={workspaceContextQuery.isLoading}
                              className="inline-flex h-8 max-w-[8rem] items-center gap-1.5 rounded-full bg-primary-100/70 px-2.5 text-xs font-medium text-primary-600 transition-colors hover:bg-primary-200/80 disabled:cursor-wait disabled:opacity-60 dark:hover:bg-primary-800/60"
                            ...
                            {isWorkspaceMenuOpen && (
                              <div className="absolute bottom-full left-0 z-[200] mb-2 min-w-[13rem] overflow-hidden rounded-xl border border-neutral-200 bg-white p-1 shadow-xl animate-in fade-in slide-in-from-bottom-2 duration-150 dark:border-neutral-700 dark:bg-neutral-900">
                                <div className="px-3 py-2 text-[10px] font-semibold uppercase tracking-wider text-neutral-400">
                                  Workspace context
                                </div>
                                {workspaceEntries.map((workspace) => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={cn(
                                        'flex w-full flex-col rounded-lg px-3 py-2 text-left text-sm transition-colors disabled:cursor-wait disabled:opacity-60',
                                        selected
                                          ? 'bg-neutral-100 text-neutral-950 dark:bg-neutral-800 dark:text-neutral-50'
                                          : 'text-neutral-700 hover:bg-neutral-50 dark:text-neutral-300 dark:hover:bg-neutral-800/60',
                                      )}
                                    >
                                      ...
                                      <span className="mt-0.5 max-w-[11rem] truncate text-[11px] text-neutral-500">
                                ...
                                <button
                                  ...
                                  className="mt-1 flex w-full rounded-lg px-3 py-2 text-left text-sm font-medium text-primary-600 transition-colors hover:bg-neutral-50 dark:text-primary-300 dark:hover:bg-neutral-800/60"
                                >
                                  Browse files
                                </button>
